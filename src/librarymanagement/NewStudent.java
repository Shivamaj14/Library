...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Btech", "BCA", "BBA", "MBA", "MCA", "MSc" }));
        ...
        setSize(new java.awt.Dimension(448, 521));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql="insert into student (StudentId,Name,FatherName,Course,Branch,Year,Semester,EmailId,MobileNo) values (?,?,?,?,?,?,?,?,?)";
        try
        {
